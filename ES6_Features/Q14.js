...
// Problem Statement:
// You are given two nested objects: profile and updates. Your task is to merge the two objects using 
// the spread operator, ensuring that specific nested properties in updates overwrite those in profile.
...
let merge = {...profile, ...updates, address: {...profile.address, ...updates.address}};
console.log(merge);